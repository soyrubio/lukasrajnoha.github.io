...
if (document.getElementById && document.childNodes && document.createElement) {
    if (!(window.MathJax && MathJax.Hub)) {
            ...
            a.Ajax = {
                ...
                loader: {
                    JS: function (k, m) {
                        ...
                        this.loading[k] = {callback: m, timeout: setTimeout(l, this.timeout), status: this.STATUS.OK, script: i};
        ...
        MathJax.Hub.Startup = {
            ...
            Cookie: function () {
                return this.queue.Push(["Post", this.signal, "Begin Cookie"], ["Get", MathJax.HTML.Cookie, "menu", MathJax.Hub.config.menuSettings], [function (d) {
                    ...
                    if (d.menuSettings.CHTMLpreview && !MathJax.Extension["CHTML-preview"]) {
        ...
        (function (d) {
            ...
            }, {id: "Jax", version: "2.5.0", directory: e + "/jax", extensionDir: e + "/extensions"});
            ...
            }, {id: "InputJax", version: "2.5.0", directory: g.directory + "/input", extensionDir: g.extensionDir});
            ...
            b.OutputJax.Error = {
                id: "Error", version: "2.5.0", config: {}, ContextMenu: function () {
            ...
            b.InputJax.Error = {id: "Error", version: "2.5.0", config: {}, sourceMenuTitle: ["Original", "Original Form"]}
        })("MathJax");
        (function (n) {
            var g = window[n];
            if (!g) {
            ...
            if (b.length === 0 && f.namespaceURI) {
                b = document.getElementsByTagNameNS(f.namespaceURI, "script")
            }
            ...
            c.Browser.Select({
                Safari: function (j) {
                    ...
                    if (document.documentMode < 10 && !r.params.NoMathPlayer) {
                        try {
